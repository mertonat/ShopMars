...
public class PayCollider : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _StoreManager = GameObject.FindWithTag("Managers").GetComponent<StoreManager>();
    ...
    private void PayOut()
    {
        ...
        _StoreManager.Unlocked(gameObject.transform.parent.name);
